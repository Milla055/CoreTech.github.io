...
--
-- Gép: localhost:8889
-- Létrehozás ideje: 2026. Már 24. 08:56
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `getConfigurationDetails` (IN `configIdIN` BIGINT)   BEGIN
    SELECT 
        ...
        `p`.`image_url`,
        `p`.`price`,
        `p`.`properties`  -- ← JSON specifikációk!
...
INSERT INTO `pc_configurations` (`id`, `name`, `description`, `budget_min`, `budget_max`, `use_case`, `game_types`, `requirement_level`, `total_price`, `product_id`, `is_featured`, `created_at`, `is_deleted`, `deleted_at`) VALUES
(1, 'Budget Gaming PC', 'Belépő gaming indie és régebbi játékokhoz. 1080p, közepes beállítások.', 200000, 350000, 'gaming', 'indie_casual,competitive_fps', 2, '289990.00', 250, 1, '2026-03-16 09:55:58', NULL, NULL),
(2, 'Mid-Range Gaming PC', 'Modern játékokhoz 1080p-1440p, magas beállítások.', 350000, 550000, 'gaming', 'competitive_fps,aaa_games,solo_rpg', 3, '459990.00', 251, 1, '2026-03-16 09:55:58', NULL, NULL),
(3, 'High-End Gaming PC', 'Prémium 1440p-4K, ultra beállítások, ray-tracing.', 550000, 800000, 'gaming', 'aaa_games,solo_rpg,competitive_fps', 4, '689990.00', 252, 1, '2026-03-16 09:55:58', NULL, NULL),
(4, 'Enthusiast 4K Gaming PC', 'Top tier 4K max beállítások, streaming, content creation.', 800000, 1500000, 'gaming', 'aaa_games,solo_rpg,competitive_fps', 5, '1199990.00', 253, 0, '2026-03-16 09:55:58', NULL, NULL),
(5, 'Competitive FPS Beast', 'Optimalizált competitive gaming, 240Hz+, low input lag.', 400000, 600000, 'gaming', 'competitive_fps', 3, '499990.00', 254, 1, '2026-03-16 09:55:58', NULL, NULL),
(6, 'Video Editing Workstation', 'Professzionális videószerkesztés: erős CPU, 32GB+ RAM.', 450000, 700000, 'video_editing', NULL, 4, '599990.00', 255, 0, '2026-03-16 09:55:58', NULL, NULL),
(7, 'Budget Content Creator', 'Kezdő content creator: streaming, basic videószerkesztés.', 300000, 450000, 'video_editing', NULL, 3, '379990.00', 256, 0, '2026-03-16 09:55:58', NULL, NULL),
(8, 'Developer Workstation', 'Programozói munkaállomás: gyors CPU, 32GB RAM.', 350000, 550000, 'programming', NULL, 3, '449990.00', 257, 0, '2026-03-16 09:55:58', NULL, NULL),
(9, 'Office / Home PC', 'Irodai használat: böngészés, Office, Teams, videóhívások.', 150000, 250000, 'programming', NULL, 1, '189990.00', 258, 0, '2026-03-16 09:55:58', NULL, NULL),
(10, 'All-Purpose Powerhouse', 'Univerzális: gaming, munka, content creation.', 600000, 900000, 'all_purpose', 'aaa_games,solo_rpg,competitive_fps', 4, '749990.00', 259, 1, '2026-03-16 09:55:58', NULL, NULL);
