...
--
-- Gép: localhost:8889
-- Létrehozás ideje: 2026. Már 10. 09:13
...
--
CREATE DATABASE IF NOT EXISTS `vizsgaremek` DEFAULT CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci;
USE `vizsgaremek`;
...
CREATE TABLE `users` (
  ...
  `teljesnev` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
