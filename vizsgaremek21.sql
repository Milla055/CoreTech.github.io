...
--
-- Gép: localhost:3306
-- Létrehozás ideje: 2026. Már 23. 09:39
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `getConfigurationDetails` (IN `configIdIN` BIGINT)   BEGIN
    SELECT 
        ...
        `pc`.`is_featured`,
        `pc`.`created_at`,
        `pc`.`product_id`,  -- ← ÚJ MEZŐ!
        `p`.`stock`,        -- ← Raktárkészlet
        `p`.`image_url`,    -- ← Termék kép (JAVÍTVA!)
        `p`.`price`         -- ← Aktuális ár (lehet kedvezményes)
...
--
-- A tábla adatainak kiíratása `configuration_products`
--

INSERT INTO `configuration_products` (`id`, `configuration_id`, `product_id`, `quantity`, `component_type`, `is_required`, `created_at`, `is_deleted`, `deleted_at`) VALUES
(1, 2, 101, 1, 'CPU', 1, '2026-03-23 09:39:21', NULL, NULL),
(2, 2, 102, 1, 'GPU', 1, '2026-03-23 09:39:21', NULL, NULL),
(3, 2, 103, 2, 'RAM', 1, '2026-03-23 09:39:21', NULL, NULL),
(4, 2, 104, 1, 'MOTHERBOARD', 1, '2026-03-23 09:39:21', NULL, NULL),
(5, 2, 105, 1, 'STORAGE', 1, '2026-03-23 09:39:21', NULL, NULL),
(6, 2, 106, 1, 'PSU', 1, '2026-03-23 09:39:21', NULL, NULL),
(7, 2, 107, 1, 'CASE', 1, '2026-03-23 09:39:21', NULL, NULL),
(8, 2, 108, 1, 'COOLER', 1, '2026-03-23 09:39:21', NULL, NULL);
...
(250, 'Budget Gaming PC - Indie & E-sports', 'Belépő szintű gaming PC indie játékokhoz és kompetitív FPS címekhez. Tartalmaz: Intel/AMD processzor, dedikált videokártya, 16GB RAM, 500GB SSD. Ideális 1080p játékokhoz közepes-magas beállításokkal.', NULL, '289990.00', '249990.00', 5, '/Users/markbajor/Downloads/wildfly-preview-26.1.1.Final/domain/tmp', 17, 1, '2026-03-23 09:39:21', NULL, NULL),
(251, 'Mid-Range Gaming PC - Modern Gamer', 'Kiváló ár-érték arány modern játékokhoz. Tartalmaz: erős mid-range CPU, RTX/RX GPU, 16GB DDR4, 1TB NVMe SSD. 1080p-1440p gaming ultra beállításokkal, ray-tracing támogatással.', NULL, '459990.00', '429990.00', 3, '/Users/markbajor/Downloads/wildfly-preview-26.1.1.Final/domain/tmp', 17, 1, '2026-03-23 09:39:21', NULL, NULL),
(252, 'High-End Gaming PC - Enthusiast', 'Prémium gaming élmény 1440p-4K felbontással. Tartalmaz: high-end CPU, RTX 4070/4080, 32GB DDR5, 2TB NVMe SSD. Ultra beállítások, ray-tracing, 144+ FPS.', NULL, '689990.00', '659990.00', 2, '/Users/markbajor/Downloads/wildfly-preview-26.1.1.Final/domain/tmp', 17, 1, '2026-03-23 09:39:21', NULL, NULL),
(253, '4K Enthusiast Gaming PC - Ultimate', 'A csúcs gaming élmény. Tartalmaz: flagship CPU, RTX 4090, 64GB DDR5, 4TB NVMe SSD, AIO vízhűtés. 4K ultra beállítások, VR ready, content creation.', NULL, '1190000.00', '1149000.00', 1, '/Users/markbajor/Downloads/wildfly-preview-26.1.1.Final/domain/tmp', 17, 1, '2026-03-23 09:39:21', NULL, NULL),
(254, 'Competitive FPS Beast - E-sports', 'Maximális FPS kompetitív játékokhoz (CS2, Valorant, Apex). Tartalmaz: high-frequency CPU, mid-high GPU, 32GB fast RAM, 1TB NVMe. 240+ FPS 1080p-en, low latency.', NULL, '549990.00', '519990.00', 4, '/Users/markbajor/Downloads/wildfly-preview-26.1.1.Final/domain/tmp', 17, 1, '2026-03-23 09:39:21', NULL, NULL),
(255, 'Content Creator Workstation - Pro', 'Videószerkesztés, streaming, rendering. Tartalmaz: multi-core CPU, professional GPU, 64GB RAM, 4TB storage. 4K editing, color grading, fast renders.', NULL, '799990.00', '769990.00', 3, '/Users/markbajor/Downloads/wildfly-preview-26.1.1.Final/domain/tmp', 17, 1, '2026-03-23 09:39:21', NULL, NULL),
(256, 'Developer Workstation - Code Master', 'Programozás, virtualizáció, multi-tasking. Tartalmaz: high-core CPU, 64GB RAM, 2TB NVMe, Linux kompatibilis. Docker, VM-ek, IDE-k futtatása.', NULL, '599990.00', '569990.00', 5, '/Users/markbajor/Downloads/wildfly-preview-26.1.1.Final/domain/tmp', 17, 1, '2026-03-23 09:39:21', NULL, NULL),
(257, 'Video Editing Workstation - Studio', 'Professzionális videószerkesztés 4K/8K. Tartalmaz: workstation CPU, professional GPU, 128GB RAM, 8TB storage RAID. DaVinci Resolve, Premiere Pro ready.', NULL, '1490000.00', '1449000.00', 2, '/Users/markbajor/Downloads/wildfly-preview-26.1.1.Final/domain/tmp', 17, 1, '2026-03-23 09:39:21', NULL, NULL),
(258, 'All-Purpose Powerhouse - Universal', 'Mindenre alkalmas erőgép. Tartalmaz: balanced CPU/GPU, 32GB RAM, 2TB SSD. Gaming, munka, content creation egy gépen. Kiváló sokoldalúság.', NULL, '849990.00', '819990.00', 3, '/Users/markbajor/Downloads/wildfly-preview-26.1.1.Final/domain/tmp', 17, 1, '2026-03-23 09:39:21', NULL, NULL),
(259, 'Office & Basic PC - Productivity', 'Irodai munka, böngészés, Office programok. Tartalmaz: efficient CPU, 16GB RAM, 512GB SSD, integrated graphics. Csendes, energiatakarékos.', NULL, '189990.00', '169990.00', 8, '/Users/markbajor/Downloads/wildfly-preview-26.1.1.Final/domain/tmp', 17, 1, '2026-03-23 09:39:21', NULL, NULL);
