...
--
-- Gép: localhost:8889
-- Létrehozás ideje: 2025. Dec 02. 10:07
...
INSERT INTO `products` (`id`, `name`, `description`, `price`, `p_price`, `stock`, `image_url`, `category_id`, `brand_id`, `created_at`, `is_deleted`, `deleted_at`) VALUES
(31, 'Intel Core i7-12700K', '12th Gen Intel CPU', '399.99', '349.99', 50, 'https://example.com/i7.png', 1, 1, '2025-10-03 07:23:38', NULL, NULL),
(32, 'AMD Ryzen 7 5800X', '8-core AMD CPU', '349.99', '299.99', 40, 'https://example.com/ryzen.png', 1, 2, '2025-10-03 07:23:38', NULL, NULL),
(33, 'NVIDIA RTX 3080', 'High-end GPU', '799.99', '749.99', 20, 'https://example.com/rtx3080.png', 2, 3, '2025-10-03 07:23:38', NULL, NULL),
(34, 'ASUS ROG Strix Z690', 'Gaming motherboard', '279.99', '229.99', 30, 'https://example.com/z690.png', 3, 4, '2025-10-03 07:23:38', NULL, NULL),
(35, 'Corsair Vengeance 16GB', 'DDR4 RAM', '89.99', '39.99', 100, 'https://example.com/vengeance.png', 4, 5, '2025-10-03 07:23:38', NULL, NULL),
(36, 'Samsung 970 EVO 1TB', 'NVMe SSD', '129.99', '79.99', 60, 'https://example.com/970evo.png', 5, 6, '2025-10-03 07:23:38', NULL, NULL),
(37, 'Corsair RM750x', '750W PSU', '119.99', '69.99', 45, 'https://example.com/rm750x.png', 6, 7, '2025-10-03 07:23:38', NULL, NULL),
(38, 'NZXT H510', 'Mid-tower case', '69.99', '19.99', 25, 'https://example.com/h510.png', 7, 8, '2025-10-03 07:23:38', NULL, NULL),
(39, 'Noctua NH-U12S', 'CPU cooler', '69.99', '19.99', 35, 'https://example.com/nhu12s.png', 8, 9, '2025-10-03 07:23:38', NULL, NULL),
(40, 'Dell UltraSharp 27\"', '4K monitor', '499.99', '449.99', 15, 'https://example.com/ultrasharp.png', 9, 10, '2025-10-03 07:23:38', NULL, NULL),
(41, 'Logitech G Pro X', 'Mechanical keyboard', '129.99', '79.99', 50, 'https://example.com/gprox.png', 10, 11, '2025-10-03 07:23:38', NULL, NULL),
(42, 'Razer DeathAdder V2', 'Gaming mouse', '69.99', '19.99', 70, 'https://example.com/deathadder.png', 11, 12, '2025-10-03 07:23:38', NULL, NULL),
(43, 'Dell XPS 13', '13-inch laptop', '999.99', '949.99', 10, 'https://example.com/xps13.png', 12, 13, '2025-10-03 07:23:38', NULL, NULL),
(44, 'TP-Link Archer C7', 'Wi-Fi router', '79.99', '29.99', 30, 'https://example.com/archer.png', 14, 14, '2025-10-03 07:23:38', NULL, NULL),
(45, 'Windows 11 Pro', 'Operating system', '149.99', '99.99', 100, 'https://example.com/win11.png', 15, 15, '2025-10-03 07:23:38', NULL, NULL);
...
(2, 'gerike', 'gercso@gmail.com', '+36303458912', 'asder', 'customer', '2025-09-05 07:53:57', 0, 0, NULL),
...
(7, 'lillat', 'lilla.toth@example.com', '+36704231111', 'hash4567', 'customer', '2023-02-18 15:40:00', 0, 0, NULL),
...
(12, 'gaborm', 'gabor.molnar@example.com', '+36303458938', 'hash9012', 'customer', '2023-05-12 06:50:00', 0, 0, NULL),
...
(16, 'pistike', 'pistike@gmail.com', '', 'asder123', 'customer', '2025-11-20 09:18:40', 0, 0, NULL);
