...
--
-- Gép: localhost:8889
-- Létrehozás ideje: 2026. Ápr 20. 09:21
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `getRecommendedConfigurations` (IN `budgetMinIN` INT, IN `budgetMaxIN` INT, IN `useCaseIN` VARCHAR(50), IN `selectedGameIdsIN` TEXT)   BEGIN
    ...
    -- Üres string-et nullra konvertáljuk
    SET selectedGameIdsIN = NULLIF(selectedGameIdsIN, '');
    
    -- Ha vannak kiválasztott játékok, megkeressük a legmagasabb requirement level-t
    ...
    IF useCaseIN = 'gaming' AND selectedGameIdsIN IS NOT NULL AND selectedGameIdsIN != '' THEN
        ...
        WHERE `pc`.`is_deleted` IS NULL
          ...
          AND `pc`.`total_price` >= budgetMinIN
          AND `pc`.`total_price` <= budgetMaxIN
    ...
    -- ========================================
    -- GAMING + nincs játék kiválasztva
    -- ========================================
...
(26, 1, '2026-03-30 08:54:19', '2026-03-30 08:54:19', NULL, NULL);
...
INSERT INTO `cart_items` (`id`, `cart_id`, `product_id`, `quantity`, `created_at`, `updated_at`, `is_deleted`, `deleted_at`) VALUES
(1, 26, 42, 1, '2026-03-30 08:54:19', '2026-03-30 08:54:19', NULL, NULL);
...
CREATE TABLE `games` (
  ...
  `name` varchar(255) NOT NULL,
  `game_type` enum('solo_rpg','competitive_fps','aaa_games','indie_casual') NOT NULL,
...
CREATE TABLE `pc_configurations` (
  ...
  `total_price` decimal(10,2) NOT NULL,
  `product_id` bigint(20) DEFAULT NULL COMMENT 'Link to the actual product in products table',
...
INSERT INTO `pc_configurations` (`id`, `name`, `description`, `use_case`, `game_types`, `requirement_level`, `total_price`, `product_id`, `is_featured`, `created_at`, `is_deleted`, `deleted_at`) VALUES
(1, 'Budget Gaming PC', 'Belépő gaming indie és régebbi játékokhoz. 1080p, közepes beállítások.', 'gaming', 'indie_casual,competitive_fps', 2, '289990.00', 250, 1, '2026-03-16 09:55:58', NULL, NULL),
(2, 'Mid-Range Gaming PC', 'Modern játékokhoz 1080p-1440p, magas beállítások.', 'gaming', 'competitive_fps,aaa_games,solo_rpg', 3, '459990.00', 251, 1, '2026-03-16 09:55:58', NULL, NULL),
(3, 'High-End Gaming PC', 'Prémium 1440p-4K, ultra beállítások, ray-tracing.', 'gaming', 'aaa_games,solo_rpg,competitive_fps', 4, '689990.00', 252, 1, '2026-03-16 09:55:58', NULL, NULL),
(4, 'Enthusiast 4K Gaming PC', 'Top tier 4K max beállítások, streaming, content creation.', 'gaming', 'aaa_games,solo_rpg,competitive_fps', 5, '1199990.00', 253, 0, '2026-03-16 09:55:58', NULL, NULL),
(5, 'Competitive FPS Beast', 'Optimalizált competitive gaming, 240Hz+, low input lag.', 'gaming', 'competitive_fps', 3, '499990.00', 254, 1, '2026-03-16 09:55:58', NULL, NULL),
(6, 'Video Editing Workstation', 'Professzionális videószerkesztés: erős CPU, 32GB+ RAM.', 'video_editing', NULL, 4, '599990.00', 255, 0, '2026-03-16 09:55:58', NULL, NULL),
(7, 'Budget Content Creator', 'Kezdő content creator: streaming, basic videószerkesztés.', 'video_editing', NULL, 3, '379990.00', 256, 0, '2026-03-16 09:55:58', NULL, NULL),
(8, 'Developer Workstation', 'Programozói munkaállomás: gyors CPU, 32GB RAM.', 'programming', NULL, 3, '449990.00', 257, 0, '2026-03-16 09:55:58', NULL, NULL),
(9, 'Office / Home PC', 'Irodai használat: böngészés, Office, Teams, videóhívások.', 'programming', NULL, 1, '189990.00', 258, 0, '2026-03-16 09:55:58', NULL, NULL),
(10, 'All-Purpose Powerhouse', 'Univerzális: gaming, munka, content creation.', 'all_purpose', 'aaa_games,solo_rpg,competitive_fps', 4, '749990.00', 259, 1, '2026-03-16 09:55:58', NULL, NULL);

-- --------------------------------------------------------

--
-- Tábla szerkezet ehhez a táblához `prebuilt_pcs`
--
...
CREATE TABLE `prebuilt_pcs` (
  ...
  `use_case` enum('gaming','video_editing','programming','all_purpose') NOT NULL DEFAULT 'gaming',
  `game_types` varchar(255) DEFAULT NULL,
  `requirement_level` tinyint(4) NOT NULL DEFAULT '1',
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `is_deleted` tinyint(1) DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL
...
--
-- A tábla adatainak kiíratása `prebuilt_pcs`
--

INSERT INTO `prebuilt_pcs` (`id`, `name`, `description`, `properties`, `price`, `stock`, `image_url`, `use_case`, `game_types`, `requirement_level`, `created_at`, `is_deleted`, `deleted_at`) VALUES
(250, 'Office Value 14. Generációs konfiguráció - i3-14100, 16GB DDR4 3200MHz RAM, 500GB M.2 (2100/3500), HDD nélkül, Integrált Intel UHD ', 'Megfelelő otthoni munkára/használatra, Indie játékok futtatására', '{\"cpu\": \"Intel Core i3 14100 (4 mag, 8 szál, 3,5-4,7GHz, 12MB cache)\", \"gpu\": \"Integrált Intel UHD\", \"psu\": \"600W táp\", \"ram\": \"16GB (2x8GB DDR4 3200MHz) RAM\", \"case\": \"Zalman T8 vagy hasonló ház\", \"cooler\": \"Gyári hűtés\", \"storage\": \"500GB m.2 SSD (2100Mbps írás/3500Mbps olvasás)\", \"motherboard\": \"Gigabyte/ASUS/MSI H610M\"}', '289990.00', 5, '/Users/markbajor/Downloads/wildfly-preview-26.1.1.Final/domain/tmp', 'all_purpose', 'indie_casual,competitive_fps', 2, '2026-03-23 11:18:01', NULL, NULL),
(251, 'Imperium Ryzen 5 Business PRO PC - Ryzen 5-5500, A520, 16GB RAM, 480GB SSD, RTX 3050 6GB', 'Kiváló ár-érték arány modern játékokhoz. 1080p-1440p gaming ultra beállításokkal, ray-tracing támogatással.', '{\"cpu\": \"AMD Ryzen 5 5500 (AM4)\", \"gpu\": \"nVidia GeForce RTX 3050 6GB GDDR6\", \"psu\": \"400W tápegység\", \"ram\": \"8GB DDR4 RAM\", \"case\": \"Business 3722 ház\", \"cooler\": \"Tower cooler\", \"storage\": \"480GB SATA SSD\", \"motherboard\": \"ASUS PRIME A520M-E/CSM\"}', '459990.00', 3, '/Users/markbajor/Downloads/wildfly-preview-26.1.1.Final/domain/tmp', 'gaming', 'competitive_fps,adventure,simulation', 4, '2026-03-23 11:18:01', NULL, NULL),
(252, 'Skynet Gamer PC - ASUS Prime A520M-E - Ryzen 5 5500 6x4,2GHz - 16GB DDR4 - Kingston 1TB M.2 SSD - v152 -Ráadás Cooler -RTX 3050 6GB -NB5 -', 'Prémium gaming élmény 1440p-4K felbontással. Ultra beállítások, ray-tracing, 144+ FPS.', '{\"cpu\": \"Ryzen 5 5500 6x4,2GHz\", \"gpu\": \"RTX 3050 6GB\", \"psu\": \"850W 80+ Gold Modular\", \"ram\": \"16GB DDR4\", \"case\": \"Full-Tower ATX RGB Tempered Glass\", \"cooler\": \"240mm AIO Liquid Cooler\", \"storage\": \"Kingston 1TB M.2 SSD\", \"motherboard\": \"Z790 / X670 chipset\"}', '689990.00', 2, '/Users/markbajor/Downloads/wildfly-preview-26.1.1.Final/domain/tmp', 'gaming', 'aaa_titles,competitive_fps,adventure', 5, '2026-03-23 11:18:01', NULL, NULL),
(253, '4K Enthusiast Gaming PC - Ultimate', 'A csúcs gaming élmény. 4K ultra beállítások, VR ready, content creation.', '{\"cpu\": \"Intel Core i9-14900K / AMD Ryzen 9 7950X\", \"gpu\": \"NVIDIA RTX 4090 24GB\", \"psu\": \"1200W 80+ Platinum Modular\", \"ram\": \"64GB DDR5 6000MHz (2x32GB)\", \"case\": \"Premium Full-Tower RGB Tempered Glass\", \"cooler\": \"360mm AIO Liquid Cooler RGB\", \"storage\": \"4TB NVMe Gen4 SSD (2x2TB)\", \"motherboard\": \"Z790 / X670E chipset\"}', '1190000.00', 1, '/Users/markbajor/Downloads/wildfly-preview-26.1.1.Final/domain/tmp', 'gaming', 'aaa_titles,vr_gaming,streaming', 5, '2026-03-23 11:18:01', NULL, NULL),
(254, 'Competitive FPS Beast - E-sports', 'Maximális FPS kompetitív játékokhoz (CS2, Valorant, Apex). 240+ FPS 1080p-en, low latency.', '{\"cpu\": \"Intel Core i5-14600K / AMD Ryzen 7 7700X\", \"gpu\": \"NVIDIA RTX 4060 Ti 8GB / AMD RX 7700 XT\", \"psu\": \"750W 80+ Gold\", \"ram\": \"32GB DDR5 6000MHz Low Latency\", \"case\": \"Mid-Tower Airflow Optimized\", \"cooler\": \"Tower Air Cooler\", \"storage\": \"1TB NVMe Gen4 SSD\", \"motherboard\": \"Z790 / B650 chipset\"}', '549990.00', 4, '/Users/markbajor/Downloads/wildfly-preview-26.1.1.Final/domain/tmp', 'gaming', 'competitive_fps,adventure,simulation', 4, '2026-03-23 11:18:01', NULL, NULL),
(255, 'Content Creator Workstation - Pro', 'Videószerkesztés, streaming, rendering. 4K editing, color grading, fast renders.', '{\"cpu\": \"Intel Core i9-13900K / AMD Ryzen 9 7900X\", \"gpu\": \"NVIDIA RTX 4070 12GB\", \"psu\": \"1000W 80+ Gold Modular\", \"ram\": \"64GB DDR5 5600MHz (4x16GB)\", \"case\": \"Full-Tower Silent Optimized\", \"cooler\": \"280mm AIO Liquid Cooler\", \"storage\": \"2TB NVMe Gen4 SSD + 4TB HDD\", \"motherboard\": \"Z790 / X670 chipset\"}', '799990.00', 3, '/Users/markbajor/Downloads/wildfly-preview-26.1.1.Final/domain/tmp', 'video_editing', 'aaa_titles,competitive_fps,adventure', 5, '2026-03-23 11:18:01', NULL, NULL),
(256, 'Developer Workstation - Code Master', 'Programozás, virtualizáció, multi-tasking. Docker, VM-ek, IDE-k futtatása.', '{\"cpu\": \"Intel Core i7-13700 / AMD Ryzen 9 5900X\", \"gpu\": \"NVIDIA RTX 4060 8GB\", \"psu\": \"750W 80+ Gold\", \"ram\": \"64GB DDR4 3600MHz (4x16GB)\", \"case\": \"Mid-Tower Silent\", \"cooler\": \"Tower Air Cooler\", \"extras\": \"Linux compatible\", \"storage\": \"2TB NVMe SSD + 2TB SATA SSD\", \"motherboard\": \"B660 / B550 chipset\"}', '599990.00', 5, '/Users/markbajor/Downloads/wildfly-preview-26.1.1.Final/domain/tmp', 'programming', 'aaa_titles,competitive_fps,adventure', 4, '2026-03-23 11:18:01', NULL, NULL),
(257, 'Video Editing Workstation - Studio', 'Professzionális videószerkesztés 4K/8K. DaVinci Resolve, Premiere Pro ready.', '{\"cpu\": \"AMD Ryzen Threadripper 3960X 24-core\", \"gpu\": \"NVIDIA RTX A4000 16GB\", \"psu\": \"1600W 80+ Platinum\", \"ram\": \"128GB DDR4 3200MHz ECC (8x16GB)\", \"case\": \"Workstation Full-Tower\", \"cooler\": \"Custom Loop Water Cooling\", \"storage\": \"8TB NVMe RAID (4x2TB) + 16TB HDD RAID\", \"motherboard\": \"TRX40 chipset\"}', '1490000.00', 2, '/Users/markbajor/Downloads/wildfly-preview-26.1.1.Final/domain/tmp', 'video_editing', 'aaa_titles,vr_gaming,streaming', 5, '2026-03-23 11:18:01', NULL, NULL),
(258, 'All-Purpose Powerhouse - Universal', 'Mindenre alkalmas erőgép. Gaming, munka, content creation egy gépen. Kiváló sokoldalúság.', '{\"cpu\": \"Intel Core i7-14700K / AMD Ryzen 7 7700X\", \"gpu\": \"NVIDIA RTX 4070 12GB\", \"psu\": \"850W 80+ Gold Modular\", \"ram\": \"32GB DDR5 5600MHz (2x16GB)\", \"case\": \"Mid-Tower RGB Tempered Glass\", \"cooler\": \"240mm AIO Liquid Cooler\", \"storage\": \"2TB NVMe Gen4 SSD\", \"motherboard\": \"Z790 / B650 chipset\"}', '849990.00', 3, '/Users/markbajor/Downloads/wildfly-preview-26.1.1.Final/domain/tmp', 'all_purpose', 'aaa_titles,vr_gaming,streaming', 5, '2026-03-23 11:18:01', NULL, NULL),
(259, 'Office & Basic PC - Productivity', 'Irodai munka, böngészés, Office programok. Csendes, energiatakarékos.', '{\"cpu\": \"Intel Core i3-12100 / AMD Ryzen 5 5600G\", \"gpu\": \"Integrated Graphics\", \"psu\": \"450W 80+ Bronze\", \"ram\": \"16GB DDR4 3200MHz (2x8GB)\", \"case\": \"Compact MicroATX\", \"cooler\": \"Stock cooler\", \"storage\": \"512GB NVMe SSD\", \"motherboard\": \"H610 / A520 chipset\"}', '189990.00', 8, '/Users/markbajor/Downloads/wildfly-preview-26.1.1.Final/domain/tmp', 'all_purpose', 'indie_casual,competitive_fps', 2, '2026-03-23 11:18:01', NULL, NULL),
(260, 'Entry Gaming PC - RTX 3050', 'Belépő szintű gaming PC 1080p játékokhoz. E-sports és indie játékokra optimalizálva. Tartalmaz: AMD Ryzen 5, RTX 3050, 16GB DDR4, 500GB SSD.', '{\"os\": \"Windows 11 Home\", \"cpu\": \"AMD Ryzen 5 5500 6-core 4.2GHz\", \"gpu\": \"NVIDIA GeForce RTX 3050 8GB GDDR6\", \"psu\": \"500W 80+ Bronze\", \"ram\": \"16GB DDR4 3200MHz (2x8GB)\", \"case\": \"Mid-Tower ATX Black\", \"cooler\": \"Stock AMD Wraith Stealth\", \"storage\": \"500GB NVMe SSD\", \"motherboard\": \"A520 AM4 chipset\"}', '269990.00', 12, '/Users/markbajor/Downloads/wildfly-preview-26.1.1.Final/domain/tmp', 'gaming', 'indie_casual,competitive_fps', 2, '2026-03-24 08:54:40', NULL, NULL),
(261, 'Budget E-sports PC - GTX 1660 Super', 'Kompetitív FPS játékokhoz optimalizált PC. CS2, Valorant, Apex 144+ FPS 1080p-en. Tartalmaz: Intel Core i5-12400F, GTX 1660 Super, 16GB DDR4.', '{\"os\": \"Windows 11 Home\", \"cpu\": \"Intel Core i5-12400F 6-core 4.4GHz\", \"gpu\": \"NVIDIA GeForce GTX 1660 Super 6GB GDDR6\", \"psu\": \"500W 80+ Bronze\", \"ram\": \"16GB DDR4 3200MHz (2x8GB)\", \"case\": \"MicroATX Compact Black\", \"cooler\": \"Stock Intel cooler\", \"storage\": \"512GB NVMe SSD\", \"motherboard\": \"B660M DDR4\"}', '279990.00', 10, '/Users/markbajor/Downloads/wildfly-preview-26.1.1.Final/domain/tmp', 'gaming', 'indie_casual,competitive_fps', 2, '2026-03-24 08:54:40', NULL, NULL),
(262, 'AMD Budget Gaming PC - RX 6600', 'Kiváló ár-érték arány AMD platformon. 1080p gaming 60+ FPS modern játékokban. Tartalmaz: Ryzen 5 5600, RX 6600, 16GB DDR4, 1TB SSD.', '{\"os\": \"Windows 11 Home\", \"cpu\": \"AMD Ryzen 5 5600 6-core 4.4GHz\", \"gpu\": \"AMD Radeon RX 6600 8GB GDDR6\", \"psu\": \"550W 80+ Bronze\", \"ram\": \"16GB DDR4 3600MHz (2x8GB)\", \"case\": \"Mid-Tower ATX Mesh Front\", \"cooler\": \"Tower Air Cooler 4-heatpipe\", \"storage\": \"1TB NVMe SSD\", \"motherboard\": \"B550M AM4\"}', '299990.00', 8, '/Users/markbajor/Downloads/wildfly-preview-26.1.1.Final/domain/tmp', 'gaming', 'indie_casual,competitive_fps', 2, '2026-03-24 08:54:40', NULL, NULL),
(263, 'Intel Budget Gamer - RTX 3060', 'Intel platform 1080p/1440p gaming PC. Ray-tracing támogatás. Tartalmaz: i5-12400F, RTX 3060 12GB, 16GB DDR4, 512GB NVMe.', '{\"os\": \"Windows 11 Home\", \"cpu\": \"Intel Core i5-12400F 6-core 4.4GHz\", \"gpu\": \"NVIDIA GeForce RTX 3060 12GB GDDR6\", \"psu\": \"600W 80+ Bronze\", \"ram\": \"16GB DDR4 3200MHz (2x8GB)\", \"case\": \"Mid-Tower RGB Tempered Glass\", \"cooler\": \"Stock Intel cooler\", \"storage\": \"512GB NVMe Gen3 SSD\", \"motherboard\": \"B660 DDR4\"}', '329990.00', 7, '/Users/markbajor/Downloads/wildfly-preview-26.1.1.Final/domain/tmp', 'gaming', 'indie_casual,competitive_fps', 3, '2026-03-24 08:54:40', NULL, NULL),
(264, 'Starter Gaming PC - Intel Arc A750', 'Modern entry-level gaming Intel Arc GPU-val. 1080p gaming, content creation. Tartalmaz: i5-13400F, Arc A750, 16GB DDR5, 1TB NVMe.', '{\"os\": \"Windows 11 Home\", \"cpu\": \"Intel Core i5-13400F 10-core 4.6GHz\", \"gpu\": \"Intel Arc A750 8GB GDDR6\", \"psu\": \"550W 80+ Bronze\", \"ram\": \"16GB DDR5 4800MHz (2x8GB)\", \"case\": \"Mid-Tower Black Mesh\", \"cooler\": \"Stock Intel cooler\", \"storage\": \"1TB NVMe Gen4 SSD\", \"motherboard\": \"B760 DDR5\"}', '339990.00', 6, '/Users/markbajor/Downloads/wildfly-preview-26.1.1.Final/domain/tmp', 'gaming', 'indie_casual,competitive_fps', 3, '2026-03-24 08:54:40', NULL, NULL),
(265, 'Mid-Range Gamer - RTX 4060', '1080p/1440p gaming erőgép. Modern játékok ultra beállításokkal. Tartalmaz: Ryzen 5 7600, RTX 4060 8GB, 32GB DDR5, 1TB NVMe.', '{\"os\": \"Windows 11 Home\", \"cpu\": \"AMD Ryzen 5 7600 6-core 5.1GHz\", \"gpu\": \"NVIDIA GeForce RTX 4060 8GB GDDR6\", \"psu\": \"650W 80+ Bronze Modular\", \"ram\": \"32GB DDR5 5200MHz (2x16GB)\", \"case\": \"Mid-Tower RGB Tempered Glass\", \"cooler\": \"Tower Air Cooler RGB\", \"storage\": \"1TB NVMe Gen4 SSD\", \"motherboard\": \"B650 AM5\"}', '389990.00', 8, '/Users/markbajor/Downloads/wildfly-preview-26.1.1.Final/domain/tmp', 'gaming', 'competitive_fps,adventure,simulation', 3, '2026-03-24 08:54:40', NULL, NULL),
(266, 'AMD Performance PC - RX 7600 XT', 'AMD gaming platform 1440p-re optimalizálva. RDNA3 architektúra. Tartalmaz: Ryzen 7 5700X, RX 7600 XT, 32GB DDR4, 2TB NVMe.', '{\"os\": \"Windows 11 Home\", \"cpu\": \"AMD Ryzen 7 5700X 8-core 4.6GHz\", \"gpu\": \"AMD Radeon RX 7600 XT 16GB GDDR6\", \"psu\": \"700W 80+ Gold\", \"ram\": \"32GB DDR4 3600MHz (2x16GB)\", \"case\": \"Full-Tower Mesh RGB\", \"cooler\": \"240mm AIO Liquid Cooler\", \"storage\": \"2TB NVMe Gen3 SSD\", \"motherboard\": \"B550 AM4\"}', '429990.00', 6, '/Users/markbajor/Downloads/wildfly-preview-26.1.1.Final/domain/tmp', 'gaming', 'competitive_fps,adventure,simulation', 4, '2026-03-24 08:54:40', NULL, NULL),
(267, 'Intel Gaming Rig - RTX 4060 Ti', 'Intel 13th gen gaming platform. 1440p ultra gaming, ray-tracing. Tartalmaz: i5-13600KF, RTX 4060 Ti, 32GB DDR5, 1TB NVMe.', '{\"os\": \"Windows 11 Home\", \"cpu\": \"Intel Core i5-13600KF 14-core 5.1GHz Unlocked\", \"gpu\": \"NVIDIA GeForce RTX 4060 Ti 8GB GDDR6\", \"psu\": \"750W 80+ Gold Modular\", \"ram\": \"32GB DDR5 5600MHz (2x16GB)\", \"case\": \"Mid-Tower RGB Tempered Glass\", \"cooler\": \"240mm AIO Liquid Cooler RGB\", \"storage\": \"1TB NVMe Gen4 SSD\", \"motherboard\": \"B760 DDR5\"}', '479990.00', 5, '/Users/markbajor/Downloads/wildfly-preview-26.1.1.Final/domain/tmp', 'gaming', 'competitive_fps,adventure,simulation', 4, '2026-03-24 08:54:40', NULL, NULL),
(268, 'Balanced Gaming PC - RTX 3070', 'Kiegyensúlyozott gaming build. 1440p high-refresh gaming. Tartalmaz: Ryzen 7 5800X3D, RTX 3070, 32GB DDR4, 2TB NVMe.', '{\"os\": \"Windows 11 Home\", \"cpu\": \"AMD Ryzen 7 5800X3D 8-core 4.5GHz\", \"gpu\": \"NVIDIA GeForce RTX 3070 8GB GDDR6\", \"psu\": \"750W 80+ Gold Modular\", \"ram\": \"32GB DDR4 3600MHz CL16 (2x16GB)\", \"case\": \"Full-Tower Mesh Airflow\", \"cooler\": \"280mm AIO Liquid Cooler\", \"storage\": \"2TB NVMe Gen4 SSD\", \"motherboard\": \"X570 AM4 WiFi\"}', '519990.00', 4, '/Users/markbajor/Downloads/wildfly-preview-26.1.1.Final/domain/tmp', 'gaming', 'competitive_fps,adventure,simulation', 4, '2026-03-24 08:54:40', NULL, NULL),
(269, 'Creator Gaming PC - RX 7700 XT', 'Gaming és content creation kombinálva. 16GB VRAM, 1440p/4K capable. Tartalmaz: Ryzen 7 7700X, RX 7700 XT, 32GB DDR5, 2TB NVMe.', '{\"os\": \"Windows 11 Pro\", \"cpu\": \"AMD Ryzen 7 7700X 8-core 5.4GHz\", \"gpu\": \"AMD Radeon RX 7700 XT 12GB GDDR6\", \"psu\": \"750W 80+ Gold Modular\", \"ram\": \"32GB DDR5 6000MHz (2x16GB)\", \"case\": \"Mid-Tower RGB Mesh\", \"cooler\": \"240mm AIO Liquid Cooler RGB\", \"storage\": \"2TB NVMe Gen4 SSD\", \"motherboard\": \"B650 AM5 WiFi\"}', '549990.00', 4, '/Users/markbajor/Downloads/wildfly-preview-26.1.1.Final/domain/tmp', 'gaming', 'competitive_fps,adventure,simulation', 4, '2026-03-24 08:54:40', NULL, NULL),
(270, 'High-Performance Gaming PC - RTX 4070', 'High-end 1440p/4K gaming. DLSS 3.0, ray-tracing ultra. Tartalmaz: i7-14700KF, RTX 4070 12GB, 32GB DDR5, 2TB NVMe, 360mm AIO.', '{\"os\": \"Windows 11 Pro\", \"cpu\": \"Intel Core i7-14700KF 20-core 5.6GHz Unlocked\", \"gpu\": \"NVIDIA GeForce RTX 4070 12GB GDDR6X\", \"psu\": \"850W 80+ Gold Modular\", \"ram\": \"32GB DDR5 6400MHz (2x16GB)\", \"case\": \"Full-Tower RGB Tempered Glass\", \"cooler\": \"360mm AIO Liquid Cooler RGB\", \"storage\": \"2TB NVMe Gen4 SSD\", \"motherboard\": \"Z790 DDR5 WiFi 6E\"}', '699990.00', 3, '/Users/markbajor/Downloads/wildfly-preview-26.1.1.Final/domain/tmp', 'gaming', 'aaa_titles,competitive_fps,adventure', 5, '2026-03-24 08:54:40', NULL, NULL),
(271, 'AMD Flagship Gaming PC - RX 7900 XT', 'AMD flagship platform. 4K gaming, 20GB VRAM. Tartalmaz: Ryzen 9 7900X, RX 7900 XT 20GB, 64GB DDR5, 4TB NVMe.', '{\"os\": \"Windows 11 Pro\", \"cpu\": \"AMD Ryzen 9 7900X 12-core 5.4GHz\", \"gpu\": \"AMD Radeon RX 7900 XT 20GB GDDR6\", \"psu\": \"1000W 80+ Gold Modular\", \"ram\": \"64GB DDR5 6000MHz (2x32GB)\", \"case\": \"Full-Tower Premium Mesh\", \"cooler\": \"360mm AIO Liquid Cooler RGB\", \"storage\": \"4TB NVMe Gen4 SSD (2x2TB)\", \"motherboard\": \"X670E AM5 WiFi 6E\"}', '849990.00', 2, '/Users/markbajor/Downloads/wildfly-preview-26.1.1.Final/domain/tmp', 'gaming', 'aaa_titles,vr_gaming,streaming', 5, '2026-03-24 08:54:40', NULL, NULL),
(272, 'Intel Extreme Gaming PC - RTX 4070 Ti Super', 'Extreme gaming teljesítmény. 4K ultra 100+ FPS. Tartalmaz: i9-14900K, RTX 4070 Ti Super 16GB, 64GB DDR5, 4TB NVMe.', '{\"os\": \"Windows 11 Pro\", \"cpu\": \"Intel Core i9-14900K 24-core 6.0GHz Unlocked\", \"gpu\": \"NVIDIA GeForce RTX 4070 Ti Super 16GB GDDR6X\", \"psu\": \"1000W 80+ Platinum Modular\", \"ram\": \"64GB DDR5 6800MHz (2x32GB)\", \"case\": \"Premium Full-Tower Dual Chamber\", \"cooler\": \"360mm AIO Liquid Cooler RGB Premium\", \"storage\": \"4TB NVMe Gen4 SSD (2x2TB)\", \"motherboard\": \"Z790 DDR5 WiFi 6E Premium\"}', '999990.00', 2, '/Users/markbajor/Downloads/wildfly-preview-26.1.1.Final/domain/tmp', 'gaming', 'aaa_titles,vr_gaming,streaming', 5, '2026-03-24 08:54:40', NULL, NULL),
(273, 'Enthusiast Workstation - RTX 4080', 'Gaming és workstation kombó. 4K/8K capable. Tartalmaz: Ryzen 9 7950X, RTX 4080 16GB, 128GB DDR5, 8TB storage.', '{\"os\": \"Windows 11 Pro for Workstations\", \"cpu\": \"AMD Ryzen 9 7950X 16-core 5.7GHz\", \"gpu\": \"NVIDIA GeForce RTX 4080 16GB GDDR6X\", \"psu\": \"1200W 80+ Platinum Modular\", \"ram\": \"128GB DDR5 6000MHz (4x32GB)\", \"case\": \"Workstation Full-Tower\", \"cooler\": \"Custom 420mm AIO + VRM Heatsinks\", \"storage\": \"8TB NVMe Gen4 (4x2TB RAID 0) + 4TB HDD\", \"motherboard\": \"X670E AM5 WiFi 6E\"}', '1399000.00', 1, '/Users/markbajor/Downloads/wildfly-preview-26.1.1.Final/domain/tmp', 'all_purpose', 'aaa_titles,vr_gaming,streaming', 5, '2026-03-24 08:54:40', NULL, NULL),
(274, 'Ultimate Gaming PC - RTX 4090', 'A végsők gaming PC. 4K/8K gaming, VR, AI workloads. Tartalmaz: i9-14900KS, RTX 4090 24GB, 128GB DDR5, 8TB NVMe RAID.', '{\"os\": \"Windows 11 Pro for Workstations\", \"cpu\": \"Intel Core i9-14900KS 24-core 6.2GHz Special Edition\", \"gpu\": \"NVIDIA GeForce RTX 4090 24GB GDDR6X\", \"psu\": \"1600W 80+ Titanium Modular\", \"ram\": \"128GB DDR5 7200MHz (4x32GB)\", \"case\": \"Ultra Premium Dual-Chamber RGB\", \"cooler\": \"Custom 480mm AIO + Active VRM Cooling\", \"storage\": \"8TB NVMe Gen5 (4x2TB RAID 0)\", \"motherboard\": \"Z790 APEX DDR5 WiFi 7\"}', '1899000.00', 1, '/Users/markbajor/Downloads/wildfly-preview-26.1.1.Final/domain/tmp', 'gaming', 'aaa_titles,vr_gaming,streaming', 5, '2026-03-24 08:54:40', NULL, NULL);
...
(250, 'Office Value 14. Generációs konfiguráció - i3-14100, 16GB DDR4 3200MHz RAM, 500GB M.2 (2100/3500), HDD nélkül, Integrált Intel UHD ', 'Megfelelő otthoni munkára/használatra, Indie játékok futtatására', '{\"cpu\": \"Intel Core i3 14100 (4 mag, 8 szál, 3,5-4,7GHz, 12MB cache)\", \"gpu\": \"Integrált Intel UHD\", \"psu\": \"600W táp\", \"ram\": \"16GB (2x8GB DDR4 3200MHz) RAM\", \"case\": \"Zalman T8 vagy hasonló ház\", \"cooler\": \"Gyári hűtés\", \"storage\": \"500GB m.2 SSD (2100Mbps írás/3500Mbps olvasás)\", \"motherboard\": \"Gigabyte/ASUS/MSI H610M\"}', '289990.00', '249990.00', 5, '/Users/markbajor/Downloads/wildfly-preview-26.1.1.Final/domain/tmp', 17, 1, '2026-03-23 11:18:01', NULL, NULL),
(251, 'Imperium Ryzen 5 Business PRO PC - Ryzen 5-5500, A520, 16GB RAM, 480GB SSD, RTX 3050 6GB', 'Kiváló ár-érték arány modern játékokhoz. 1080p-1440p gaming ultra beállításokkal, ray-tracing támogatással.', '{\"cpu\": \"AMD Ryzen 5 5500 (AM4)\", \"gpu\": \"nVidia GeForce RTX 3050 6GB GDDR6\", \"psu\": \"400W tápegység\", \"ram\": \"8GB DDR4 RAM\", \"case\": \"Business 3722 ház\", \"cooler\": \"Tower cooler\", \"storage\": \"480GB SATA SSD\", \"motherboard\": \"ASUS PRIME A520M-E/CSM\"}', '459990.00', '429990.00', 3, '/Users/markbajor/Downloads/wildfly-preview-26.1.1.Final/domain/tmp', 17, 1, '2026-03-23 11:18:01', NULL, NULL),
(252, 'Skynet Gamer PC - ASUS Prime A520M-E - Ryzen 5 5500 6x4,2GHz - 16GB DDR4 - Kingston 1TB M.2 SSD - v152 -Ráadás Cooler -RTX 3050 6GB -NB5 -', 'Prémium gaming élmény 1440p-4K felbontással. Ultra beállítások, ray-tracing, 144+ FPS.', '{\"cpu\": \"Ryzen 5 5500 6x4,2GHz\", \"gpu\": \"RTX 3050 6GB\", \"psu\": \"850W 80+ Gold Modular\", \"ram\": \"16GB DDR4\", \"case\": \"Full-Tower ATX RGB Tempered Glass\", \"cooler\": \"240mm AIO Liquid Cooler\", \"storage\": \"Kingston 1TB M.2 SSD\", \"motherboard\": \"Z790 / X670 chipset\"}', '689990.00', '659990.00', 2, '/Users/markbajor/Downloads/wildfly-preview-26.1.1.Final/domain/tmp', 17, 1, '2026-03-23 11:18:01', NULL, NULL),
(253, '4K Enthusiast Gaming PC - Ultimate', 'A csúcs gaming élmény. 4K ultra beállítások, VR ready, content creation.', '{\"cpu\": \"Intel Core i9-14900K / AMD Ryzen 9 7950X\", \"gpu\": \"NVIDIA RTX 4090 24GB\", \"psu\": \"1200W 80+ Platinum Modular\", \"ram\": \"64GB DDR5 6000MHz (2x32GB)\", \"case\": \"Premium Full-Tower RGB Tempered Glass\", \"cooler\": \"360mm AIO Liquid Cooler RGB\", \"storage\": \"4TB NVMe Gen4 SSD (2x2TB)\", \"motherboard\": \"Z790 / X670E chipset\"}', '1190000.00', '1149000.00', 1, '/Users/markbajor/Downloads/wildfly-preview-26.1.1.Final/domain/tmp', 17, 1, '2026-03-23 11:18:01', NULL, NULL),
(254, 'Competitive FPS Beast - E-sports', 'Maximális FPS kompetitív játékokhoz (CS2, Valorant, Apex). 240+ FPS 1080p-en, low latency.', '{\"cpu\": \"Intel Core i5-14600K / AMD Ryzen 7 7700X\", \"gpu\": \"NVIDIA RTX 4060 Ti 8GB / AMD RX 7700 XT\", \"psu\": \"750W 80+ Gold\", \"ram\": \"32GB DDR5 6000MHz Low Latency\", \"case\": \"Mid-Tower Airflow Optimized\", \"cooler\": \"Tower Air Cooler\", \"storage\": \"1TB NVMe Gen4 SSD\", \"motherboard\": \"Z790 / B650 chipset\"}', '549990.00', '519990.00', 4, '/Users/markbajor/Downloads/wildfly-preview-26.1.1.Final/domain/tmp', 17, 1, '2026-03-23 11:18:01', NULL, NULL),
(255, 'Content Creator Workstation - Pro', 'Videószerkesztés, streaming, rendering. 4K editing, color grading, fast renders.', '{\"cpu\": \"Intel Core i9-13900K / AMD Ryzen 9 7900X\", \"gpu\": \"NVIDIA RTX 4070 12GB\", \"psu\": \"1000W 80+ Gold Modular\", \"ram\": \"64GB DDR5 5600MHz (4x16GB)\", \"case\": \"Full-Tower Silent Optimized\", \"cooler\": \"280mm AIO Liquid Cooler\", \"storage\": \"2TB NVMe Gen4 SSD + 4TB HDD\", \"motherboard\": \"Z790 / X670 chipset\"}', '799990.00', '769990.00', 3, '/Users/markbajor/Downloads/wildfly-preview-26.1.1.Final/domain/tmp', 17, 1, '2026-03-23 11:18:01', NULL, NULL),
(256, 'Developer Workstation - Code Master', 'Programozás, virtualizáció, multi-tasking. Docker, VM-ek, IDE-k futtatása.', '{\"cpu\": \"Intel Core i7-13700 / AMD Ryzen 9 5900X\", \"gpu\": \"NVIDIA RTX 4060 8GB\", \"psu\": \"750W 80+ Gold\", \"ram\": \"64GB DDR4 3600MHz (4x16GB)\", \"case\": \"Mid-Tower Silent\", \"cooler\": \"Tower Air Cooler\", \"extras\": \"Linux compatible\", \"storage\": \"2TB NVMe SSD + 2TB SATA SSD\", \"motherboard\": \"B660 / B550 chipset\"}', '599990.00', '569990.00', 5, '/Users/markbajor/Downloads/wildfly-preview-26.1.1.Final/domain/tmp', 17, 1, '2026-03-23 11:18:01', NULL, NULL),
(257, 'Video Editing Workstation - Studio', 'Professzionális videószerkesztés 4K/8K. DaVinci Resolve, Premiere Pro ready.', '{\"cpu\": \"AMD Ryzen Threadripper 3960X 24-core\", \"gpu\": \"NVIDIA RTX A4000 16GB\", \"psu\": \"1600W 80+ Platinum\", \"ram\": \"128GB DDR4 3200MHz ECC (8x16GB)\", \"case\": \"Workstation Full-Tower\", \"cooler\": \"Custom Loop Water Cooling\", \"storage\": \"8TB NVMe RAID (4x2TB) + 16TB HDD RAID\", \"motherboard\": \"TRX40 chipset\"}', '1490000.00', '1449000.00', 2, '/Users/markbajor/Downloads/wildfly-preview-26.1.1.Final/domain/tmp', 17, 1, '2026-03-23 11:18:01', NULL, NULL),
(258, 'All-Purpose Powerhouse - Universal', 'Mindenre alkalmas erőgép. Gaming, munka, content creation egy gépen. Kiváló sokoldalúság.', '{\"cpu\": \"Intel Core i7-14700K / AMD Ryzen 7 7700X\", \"gpu\": \"NVIDIA RTX 4070 12GB\", \"psu\": \"850W 80+ Gold Modular\", \"ram\": \"32GB DDR5 5600MHz (2x16GB)\", \"case\": \"Mid-Tower RGB Tempered Glass\", \"cooler\": \"240mm AIO Liquid Cooler\", \"storage\": \"2TB NVMe Gen4 SSD\", \"motherboard\": \"Z790 / B650 chipset\"}', '849990.00', '819990.00', 3, '/Users/markbajor/Downloads/wildfly-preview-26.1.1.Final/domain/tmp', 17, 1, '2026-03-23 11:18:01', NULL, NULL),
(259, 'Office & Basic PC - Productivity', 'Irodai munka, böngészés, Office programok. Csendes, energiatakarékos.', '{\"cpu\": \"Intel Core i3-12100 / AMD Ryzen 5 5600G\", \"gpu\": \"Integrated Graphics\", \"psu\": \"450W 80+ Bronze\", \"ram\": \"16GB DDR4 3200MHz (2x8GB)\", \"case\": \"Compact MicroATX\", \"cooler\": \"Stock cooler\", \"storage\": \"512GB NVMe SSD\", \"motherboard\": \"H610 / A520 chipset\"}', '189990.00', '169990.00', 8, '/Users/markbajor/Downloads/wildfly-preview-26.1.1.Final/domain/tmp', 17, 1, '2026-03-23 11:18:01', NULL, NULL),
(260, 'Entry Gaming PC - RTX 3050', 'Belépő szintű gaming PC 1080p játékokhoz. E-sports és indie játékokra optimalizálva. Tartalmaz: AMD Ryzen 5, RTX 3050, 16GB DDR4, 500GB SSD.', '{\"os\": \"Windows 11 Home\", \"cpu\": \"AMD Ryzen 5 5500 6-core 4.2GHz\", \"gpu\": \"NVIDIA GeForce RTX 3050 8GB GDDR6\", \"psu\": \"500W 80+ Bronze\", \"ram\": \"16GB DDR4 3200MHz (2x8GB)\", \"case\": \"Mid-Tower ATX Black\", \"cooler\": \"Stock AMD Wraith Stealth\", \"storage\": \"500GB NVMe SSD\", \"motherboard\": \"A520 AM4 chipset\"}', '269990.00', '249990.00', 12, '/Users/markbajor/Downloads/wildfly-preview-26.1.1.Final/domain/tmp', 17, 1, '2026-03-24 08:54:40', NULL, NULL),
(261, 'Budget E-sports PC - GTX 1660 Super', 'Kompetitív FPS játékokhoz optimalizált PC. CS2, Valorant, Apex 144+ FPS 1080p-en. Tartalmaz: Intel Core i5-12400F, GTX 1660 Super, 16GB DDR4.', '{\"os\": \"Windows 11 Home\", \"cpu\": \"Intel Core i5-12400F 6-core 4.4GHz\", \"gpu\": \"NVIDIA GeForce GTX 1660 Super 6GB GDDR6\", \"psu\": \"500W 80+ Bronze\", \"ram\": \"16GB DDR4 3200MHz (2x8GB)\", \"case\": \"MicroATX Compact Black\", \"cooler\": \"Stock Intel cooler\", \"storage\": \"512GB NVMe SSD\", \"motherboard\": \"B660M DDR4\"}', '279990.00', '259990.00', 10, '/Users/markbajor/Downloads/wildfly-preview-26.1.1.Final/domain/tmp', 17, 1, '2026-03-24 08:54:40', NULL, NULL),
(262, 'AMD Budget Gaming PC - RX 6600', 'Kiváló ár-érték arány AMD platformon. 1080p gaming 60+ FPS modern játékokban. Tartalmaz: Ryzen 5 5600, RX 6600, 16GB DDR4, 1TB SSD.', '{\"os\": \"Windows 11 Home\", \"cpu\": \"AMD Ryzen 5 5600 6-core 4.4GHz\", \"gpu\": \"AMD Radeon RX 6600 8GB GDDR6\", \"psu\": \"550W 80+ Bronze\", \"ram\": \"16GB DDR4 3600MHz (2x8GB)\", \"case\": \"Mid-Tower ATX Mesh Front\", \"cooler\": \"Tower Air Cooler 4-heatpipe\", \"storage\": \"1TB NVMe SSD\", \"motherboard\": \"B550M AM4\"}', '299990.00', '279990.00', 8, '/Users/markbajor/Downloads/wildfly-preview-26.1.1.Final/domain/tmp', 17, 1, '2026-03-24 08:54:40', NULL, NULL),
(263, 'Intel Budget Gamer - RTX 3060', 'Intel platform 1080p/1440p gaming PC. Ray-tracing támogatás. Tartalmaz: i5-12400F, RTX 3060 12GB, 16GB DDR4, 512GB NVMe.', '{\"os\": \"Windows 11 Home\", \"cpu\": \"Intel Core i5-12400F 6-core 4.4GHz\", \"gpu\": \"NVIDIA GeForce RTX 3060 12GB GDDR6\", \"psu\": \"600W 80+ Bronze\", \"ram\": \"16GB DDR4 3200MHz (2x8GB)\", \"case\": \"Mid-Tower RGB Tempered Glass\", \"cooler\": \"Stock Intel cooler\", \"storage\": \"512GB NVMe Gen3 SSD\", \"motherboard\": \"B660 DDR4\"}', '329990.00', '309990.00', 7, '/Users/markbajor/Downloads/wildfly-preview-26.1.1.Final/domain/tmp', 17, 1, '2026-03-24 08:54:40', NULL, NULL),
(264, 'Starter Gaming PC - Intel Arc A750', 'Modern entry-level gaming Intel Arc GPU-val. 1080p gaming, content creation. Tartalmaz: i5-13400F, Arc A750, 16GB DDR5, 1TB NVMe.', '{\"os\": \"Windows 11 Home\", \"cpu\": \"Intel Core i5-13400F 10-core 4.6GHz\", \"gpu\": \"Intel Arc A750 8GB GDDR6\", \"psu\": \"550W 80+ Bronze\", \"ram\": \"16GB DDR5 4800MHz (2x8GB)\", \"case\": \"Mid-Tower Black Mesh\", \"cooler\": \"Stock Intel cooler\", \"storage\": \"1TB NVMe Gen4 SSD\", \"motherboard\": \"B760 DDR5\"}', '339990.00', '319990.00', 6, '/Users/markbajor/Downloads/wildfly-preview-26.1.1.Final/domain/tmp', 17, 1, '2026-03-24 08:54:40', NULL, NULL),
(265, 'Mid-Range Gamer - RTX 4060', '1080p/1440p gaming erőgép. Modern játékok ultra beállításokkal. Tartalmaz: Ryzen 5 7600, RTX 4060 8GB, 32GB DDR5, 1TB NVMe.', '{\"os\": \"Windows 11 Home\", \"cpu\": \"AMD Ryzen 5 7600 6-core 5.1GHz\", \"gpu\": \"NVIDIA GeForce RTX 4060 8GB GDDR6\", \"psu\": \"650W 80+ Bronze Modular\", \"ram\": \"32GB DDR5 5200MHz (2x16GB)\", \"case\": \"Mid-Tower RGB Tempered Glass\", \"cooler\": \"Tower Air Cooler RGB\", \"storage\": \"1TB NVMe Gen4 SSD\", \"motherboard\": \"B650 AM5\"}', '389990.00', '369990.00', 8, '/Users/markbajor/Downloads/wildfly-preview-26.1.1.Final/domain/tmp', 17, 1, '2026-03-24 08:54:40', NULL, NULL),
(266, 'AMD Performance PC - RX 7600 XT', 'AMD gaming platform 1440p-re optimalizálva. RDNA3 architektúra. Tartalmaz: Ryzen 7 5700X, RX 7600 XT, 32GB DDR4, 2TB NVMe.', '{\"os\": \"Windows 11 Home\", \"cpu\": \"AMD Ryzen 7 5700X 8-core 4.6GHz\", \"gpu\": \"AMD Radeon RX 7600 XT 16GB GDDR6\", \"psu\": \"700W 80+ Gold\", \"ram\": \"32GB DDR4 3600MHz (2x16GB)\", \"case\": \"Full-Tower Mesh RGB\", \"cooler\": \"240mm AIO Liquid Cooler\", \"storage\": \"2TB NVMe Gen3 SSD\", \"motherboard\": \"B550 AM4\"}', '429990.00', '409990.00', 6, '/Users/markbajor/Downloads/wildfly-preview-26.1.1.Final/domain/tmp', 17, 1, '2026-03-24 08:54:40', NULL, NULL),
(267, 'Intel Gaming Rig - RTX 4060 Ti', 'Intel 13th gen gaming platform. 1440p ultra gaming, ray-tracing. Tartalmaz: i5-13600KF, RTX 4060 Ti, 32GB DDR5, 1TB NVMe.', '{\"os\": \"Windows 11 Home\", \"cpu\": \"Intel Core i5-13600KF 14-core 5.1GHz Unlocked\", \"gpu\": \"NVIDIA GeForce RTX 4060 Ti 8GB GDDR6\", \"psu\": \"750W 80+ Gold Modular\", \"ram\": \"32GB DDR5 5600MHz (2x16GB)\", \"case\": \"Mid-Tower RGB Tempered Glass\", \"cooler\": \"240mm AIO Liquid Cooler RGB\", \"storage\": \"1TB NVMe Gen4 SSD\", \"motherboard\": \"B760 DDR5\"}', '479990.00', '459990.00', 5, '/Users/markbajor/Downloads/wildfly-preview-26.1.1.Final/domain/tmp', 17, 1, '2026-03-24 08:54:40', NULL, NULL),
(268, 'Balanced Gaming PC - RTX 3070', 'Kiegyensúlyozott gaming build. 1440p high-refresh gaming. Tartalmaz: Ryzen 7 5800X3D, RTX 3070, 32GB DDR4, 2TB NVMe.', '{\"os\": \"Windows 11 Home\", \"cpu\": \"AMD Ryzen 7 5800X3D 8-core 4.5GHz\", \"gpu\": \"NVIDIA GeForce RTX 3070 8GB GDDR6\", \"psu\": \"750W 80+ Gold Modular\", \"ram\": \"32GB DDR4 3600MHz CL16 (2x16GB)\", \"case\": \"Full-Tower Mesh Airflow\", \"cooler\": \"280mm AIO Liquid Cooler\", \"storage\": \"2TB NVMe Gen4 SSD\", \"motherboard\": \"X570 AM4 WiFi\"}', '519990.00', '499990.00', 4, '/Users/markbajor/Downloads/wildfly-preview-26.1.1.Final/domain/tmp', 17, 1, '2026-03-24 08:54:40', NULL, NULL),
(269, 'Creator Gaming PC - RX 7700 XT', 'Gaming és content creation kombinálva. 16GB VRAM, 1440p/4K capable. Tartalmaz: Ryzen 7 7700X, RX 7700 XT, 32GB DDR5, 2TB NVMe.', '{\"os\": \"Windows 11 Pro\", \"cpu\": \"AMD Ryzen 7 7700X 8-core 5.4GHz\", \"gpu\": \"AMD Radeon RX 7700 XT 12GB GDDR6\", \"psu\": \"750W 80+ Gold Modular\", \"ram\": \"32GB DDR5 6000MHz (2x16GB)\", \"case\": \"Mid-Tower RGB Mesh\", \"cooler\": \"240mm AIO Liquid Cooler RGB\", \"storage\": \"2TB NVMe Gen4 SSD\", \"motherboard\": \"B650 AM5 WiFi\"}', '549990.00', '529990.00', 4, '/Users/markbajor/Downloads/wildfly-preview-26.1.1.Final/domain/tmp', 17, 1, '2026-03-24 08:54:40', NULL, NULL),
(270, 'High-Performance Gaming PC - RTX 4070', 'High-end 1440p/4K gaming. DLSS 3.0, ray-tracing ultra. Tartalmaz: i7-14700KF, RTX 4070 12GB, 32GB DDR5, 2TB NVMe, 360mm AIO.', '{\"os\": \"Windows 11 Pro\", \"cpu\": \"Intel Core i7-14700KF 20-core 5.6GHz Unlocked\", \"gpu\": \"NVIDIA GeForce RTX 4070 12GB GDDR6X\", \"psu\": \"850W 80+ Gold Modular\", \"ram\": \"32GB DDR5 6400MHz (2x16GB)\", \"case\": \"Full-Tower RGB Tempered Glass\", \"cooler\": \"360mm AIO Liquid Cooler RGB\", \"storage\": \"2TB NVMe Gen4 SSD\", \"motherboard\": \"Z790 DDR5 WiFi 6E\"}', '699990.00', '679990.00', 3, '/Users/markbajor/Downloads/wildfly-preview-26.1.1.Final/domain/tmp', 17, 1, '2026-03-24 08:54:40', NULL, NULL),
(271, 'AMD Flagship Gaming PC - RX 7900 XT', 'AMD flagship platform. 4K gaming, 20GB VRAM. Tartalmaz: Ryzen 9 7900X, RX 7900 XT 20GB, 64GB DDR5, 4TB NVMe.', '{\"os\": \"Windows 11 Pro\", \"cpu\": \"AMD Ryzen 9 7900X 12-core 5.4GHz\", \"gpu\": \"AMD Radeon RX 7900 XT 20GB GDDR6\", \"psu\": \"1000W 80+ Gold Modular\", \"ram\": \"64GB DDR5 6000MHz (2x32GB)\", \"case\": \"Full-Tower Premium Mesh\", \"cooler\": \"360mm AIO Liquid Cooler RGB\", \"storage\": \"4TB NVMe Gen4 SSD (2x2TB)\", \"motherboard\": \"X670E AM5 WiFi 6E\"}', '849990.00', '819990.00', 2, '/Users/markbajor/Downloads/wildfly-preview-26.1.1.Final/domain/tmp', 17, 1, '2026-03-24 08:54:40', NULL, NULL),
(272, 'Intel Extreme Gaming PC - RTX 4070 Ti Super', 'Extreme gaming teljesítmény. 4K ultra 100+ FPS. Tartalmaz: i9-14900K, RTX 4070 Ti Super 16GB, 64GB DDR5, 4TB NVMe.', '{\"os\": \"Windows 11 Pro\", \"cpu\": \"Intel Core i9-14900K 24-core 6.0GHz Unlocked\", \"gpu\": \"NVIDIA GeForce RTX 4070 Ti Super 16GB GDDR6X\", \"psu\": \"1000W 80+ Platinum Modular\", \"ram\": \"64GB DDR5 6800MHz (2x32GB)\", \"case\": \"Premium Full-Tower Dual Chamber\", \"cooler\": \"360mm AIO Liquid Cooler RGB Premium\", \"storage\": \"4TB NVMe Gen4 SSD (2x2TB)\", \"motherboard\": \"Z790 DDR5 WiFi 6E Premium\"}', '999990.00', '969990.00', 2, '/Users/markbajor/Downloads/wildfly-preview-26.1.1.Final/domain/tmp', 17, 1, '2026-03-24 08:54:40', NULL, NULL),
(273, 'Enthusiast Workstation - RTX 4080', 'Gaming és workstation kombó. 4K/8K capable. Tartalmaz: Ryzen 9 7950X, RTX 4080 16GB, 128GB DDR5, 8TB storage.', '{\"os\": \"Windows 11 Pro for Workstations\", \"cpu\": \"AMD Ryzen 9 7950X 16-core 5.7GHz\", \"gpu\": \"NVIDIA GeForce RTX 4080 16GB GDDR6X\", \"psu\": \"1200W 80+ Platinum Modular\", \"ram\": \"128GB DDR5 6000MHz (4x32GB)\", \"case\": \"Workstation Full-Tower\", \"cooler\": \"Custom 420mm AIO + VRM Heatsinks\", \"storage\": \"8TB NVMe Gen4 (4x2TB RAID 0) + 4TB HDD\", \"motherboard\": \"X670E AM5 WiFi 6E\"}', '1399000.00', '1349000.00', 1, '/Users/markbajor/Downloads/wildfly-preview-26.1.1.Final/domain/tmp', 17, 1, '2026-03-24 08:54:40', NULL, NULL),
(274, 'Ultimate Gaming PC - RTX 4090', 'A végsők gaming PC. 4K/8K gaming, VR, AI workloads. Tartalmaz: i9-14900KS, RTX 4090 24GB, 128GB DDR5, 8TB NVMe RAID.', '{\"os\": \"Windows 11 Pro for Workstations\", \"cpu\": \"Intel Core i9-14900KS 24-core 6.2GHz Special Edition\", \"gpu\": \"NVIDIA GeForce RTX 4090 24GB GDDR6X\", \"psu\": \"1600W 80+ Titanium Modular\", \"ram\": \"128GB DDR5 7200MHz (4x32GB)\", \"case\": \"Ultra Premium Dual-Chamber RGB\", \"cooler\": \"Custom 480mm AIO + Active VRM Cooling\", \"storage\": \"8TB NVMe Gen5 (4x2TB RAID 0)\", \"motherboard\": \"Z790 APEX DDR5 WiFi 7\"}', '1899000.00', '1799000.00', 1, '/Users/markbajor/Downloads/wildfly-preview-26.1.1.Final/domain/tmp', 17, 1, '2026-03-24 08:54:40', NULL, NULL);
...
--
-- AUTO_INCREMENT a táblához `prebuilt_pcs`
--
ALTER TABLE `prebuilt_pcs`
